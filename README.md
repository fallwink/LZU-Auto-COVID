...
2. 然后，按下图所示点击1，2，3，4的次序，你可以手动触发工作流的执行来进行测试。另外工作流还自动会在北京时间每天的8点，12点，20点自动运行。
![](img/workflow.png)
...
2. Then, click in the order of 1, 2, 3 and 4 as shown in the figure below. You can manually trigger the execution of workflow to test. In addition, the workflow will automatically run at 8:00, 12:00 and 20:00 Beijing time every day.
![](img/workflow.png)
