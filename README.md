...
默认再次打卡等待时间为30分钟，如果你有需要可以修改你的fork仓库对应的[这里](.gitlab-ci.yml#L81)的`30m`替换为你想要的数值。
...
The default waiting time is 30 minutes. You can replace `30m` [here](.gitlab-ci.yml#L81) in your corresponding repository with the time you want. 
